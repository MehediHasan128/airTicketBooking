...
const TopFilter = () => {
  return (
    <div>
      <>
        <Box className="bg-white px-5 md:px-10 py-3 pb-10 lg:pb-8 rounded-xl shadow-md relative">
            {/* Radio group section */}
          <Box>
            <FormControl>
              <RadioGroup
          ...
          <Box className="flex flex-col lg:flex-row gap-5 lg:gap-10">
            <Box className="relative">
              ...
              <div className="w-fit border p-2 rounded-full bg-white shadow-md absolute top-7 md:top-5 left-[41%] md:left-[43.5%] lg:left-[46%]">
          ...
          <Box className="absolute left-[32%] md:left-[40%] lg:left-[42%] -bottom-6">
