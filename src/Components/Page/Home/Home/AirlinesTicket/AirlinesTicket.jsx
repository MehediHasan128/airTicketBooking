  ...
  return (
    <div>
      ...
      <Box className="space-y-5">
        <TicketCard ticketPrice={'3,202'} airlineLogo={biman} time={'45 minutes'} />
        <TicketCard ticketPrice={'4,502'} airlineLogo={biman} time={'45 minutes'} />
        <TicketCard ticketPrice={'2,500'} airlineLogo={usBangla} time={'1 hour 20 minutes'} />
        <TicketCard ticketPrice={'2,500'} airlineLogo={airAstra} time={'1 hour 20 minutes'} />
        <TicketCard ticketPrice={'2,500'} airlineLogo={novo} time={'1 hour 20 minutes'} />
      </Box>
    </div>
  );
};
